...
char keypad_getkey(void){
    ...
    for(i = 0; i < 4; i++){
        if(i == 0){
            PORTB = (1 << 7) | (1 << 6) | (1 << 5) | (0 << 0);
            _delay((unsigned long)((100)*(8000000/4000000.0)));
            if (!(PORTB & (1 << 4))){ valor = letras[0][0]; }
            if (!(PORTB & (1 << 5))){ valor = letras[0][1]; }
            if (!(PORTB & (1 << 6))){ valor = letras[0][2]; }
            if (!(PORTB & (1 << 7))){ valor = letras[0][3]; }
        }
        if(i == 1){
            PORTB = (1 << 7) | (1 << 6) | (1 << 5) | (1 << 0) | (0 << 1);
            _delay((unsigned long)((100)*(8000000/4000000.0)));
            if (!(PORTB & (1 << 4))){ valor = letras[1][0]; }
            if (!(PORTB & (1 << 5))){ valor = letras[1][1]; }
            if (!(PORTB & (1 << 6))){ valor = letras[1][2]; }
            if (!(PORTB & (1 << 7))){ valor = letras[1][3]; }
        }
        if(i == 2){
            PORTB = (1 << 7) | (1 << 6) | (1 << 5) | (1 << 0) | (1 << 1) | (0 << 2);
            _delay((unsigned long)((100)*(8000000/4000000.0)));
            if (!(PORTB & (1 << 4))){ valor = letras[2][0]; }
            if (!(PORTB & (1 << 5))){ valor = letras[2][1]; }
            if (!(PORTB & (1 << 6))){ valor = letras[2][2]; }
            if (!(PORTB & (1 << 7))){ valor = letras[2][3]; }
        }
        if(i == 3){
            PORTB = (1 << 7) | (1 << 6) | (1 << 5) | (1 << 0) | (1 << 1) | (1 << 2) | (0 << 3);
            _delay((unsigned long)((100)*(8000000/4000000.0)));
            if (!(PORTB & (1 << 4))){ valor = letras[3][0]; }
            if (!(PORTB & (1 << 5))){ valor = letras[3][1]; }
            if (!(PORTB & (1 << 6))){ valor = letras[3][2]; }
            if (!(PORTB & (1 << 7))){ valor = letras[3][3]; }
        }
    }
    return valor;
}
